    ...
    <div class="row">
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="course-training-five">
          <div class="img"><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/flexibility.png" alt="" /></div>
          <div class="content">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="course-training-five">
          <div class="img"><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/accessibility.png" alt="" /></div>
          <div class="content">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="course-training-five">
          <div class="img"><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/globalization.png" alt="" /></div>
          <div class="content">
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="course-training-five">
          <div class="img"><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/cost-effective.png" alt="" /></div>
          <div class="content">
...
<section class="pb-110">
  <div class="container">
    <div class="counter-5">
      <div class="item">
        <span class="graphic">
          <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/counter-graphic-5-1.svg" alt="" />
        </span>
      ...
      <div class="item">
        <span class="graphic">
          <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/counter-graphic-5-2.svg" alt="" />
        </span>
      ...
      <div class="item">
        <span class="graphic">
          <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/counter-graphic-5-3.svg" alt="" />
        </span>
      ...
      <div class="item">
        <span class="graphic">
          <img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/counter-graphic-5-4.svg" alt="" />
        </span>
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="title-three title-graphic-five">
          ...
          <span><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/graphic-5-1.svg" alt="" /></span>
        </div>
      </div>
      <div class="col-lg-8">
        <ul class="upcoming-course-five">
          ...
          <li>
            ...
            <div class="course">
              <div class="img"><img width="100%" src="<?php echo $this->crud_model->get_course_thumbnail_url($upcoming_course['id']); ?>" alt="" /></div>
              <div class="content">
    ...
    <div class="testimonial-5">
      <?php foreach($ratings->result_array() as $rating): ?>
        ...
        <div class="testimonial-item-5">
          <div class="quote"><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/icon/quote-5.svg" alt="" /></div>
          <div class="title">
            <div class="img">
          ...
          <div class="rate-no">
            <div class="icon"><img src="<?php echo site_url('assets/frontend/default-new/'); ?>image/icon/star.svg" alt="" /></div>
